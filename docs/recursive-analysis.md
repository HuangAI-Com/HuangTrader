...
Why does this matter for HuangTrader? In backtesting, the bot will get full data of the pairs according to the timerange specified. But in a dry/live run, the bot will be limited by the amount of data each exchanges gives.
...
```
usage: HuangTrader recursive-analysis [-h] [-v] [--logfile FILE] [-V] [-c PATH]
