...
To update your HuangTrader installation, please use one of the below methods, corresponding to your installation method.
...
!!! Note "Legacy installations using the `master` image"
    We're switching from master to stable for the release Images - please adjust your docker-file and replace `HuangTraderorg/HuangTrader:master` with `HuangTraderorg/HuangTrader:stable`
