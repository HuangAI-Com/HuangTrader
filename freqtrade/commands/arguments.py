...
from HuangTrader.commands.cli_options import AVAILABLE_CLI_OPTIONS
from HuangTrader.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = argparse.ArgumentParser(
            prog="HuangTrader", description="Free, open source crypto trading bot"
        )
