...
from HuangTrader.configuration.directory_operations import copy_sample_files, create_userdata_dir
from HuangTrader.constants import USERPATH_STRATEGIES
from HuangTrader.enums import RunMode
from HuangTrader.exceptions import ConfigurationError, OperationalException
from HuangTrader.util import render_template, render_template_with_fallback
...
def get_ui_download_url(version: Optional[str] = None) -> Tuple[str, str]:
    base_url = "https://api.github.com/repos/HuangTrader/frequi/"
