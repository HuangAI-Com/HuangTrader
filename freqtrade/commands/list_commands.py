...
from HuangTrader.exchange import list_available_exchanges, market_is_active
from HuangTrader.misc import parse_db_uri_for_logging, plural
from HuangTrader.resolvers import ExchangeResolver, StrategyResolver
from HuangTrader.types import ValidExchangesType
...
def start_list_exchanges(args: Dict[str, Any]) -> None:
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            print("Exchanges available for HuangTrader:")
