...
from HuangTrader.constants import LAST_BT_RESULT_FN, IntOrInf
from HuangTrader.exceptions import ConfigurationError, OperationalException
from HuangTrader.misc import file_dump_json, json_load
from HuangTrader.optimize.backtest_caching import get_backtest_metadata_filename
from HuangTrader.persistence import LocalTrade, Trade, init_db
from HuangTrader.types import BacktestHistoryEntryType, BacktestResultType
...
def analyze_trade_parallelism(results: pd.DataFrame, timeframe: str) -> pd.DataFrame:
    ...
    """
    from HuangTrader.exchange import timeframe_to_resample_freq
