class HuangTraderException(Exception):
    """
    HuangTrader base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(HuangTraderException):
    """
...
class DependencyException(HuangTraderException):
    """
...
class StrategyError(HuangTraderException):
    """
