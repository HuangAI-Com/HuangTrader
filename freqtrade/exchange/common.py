...
from HuangTrader.constants import ExchangeConfig
from HuangTrader.exceptions import DDosProtection, RetryableOrderError, TemporaryError
            ...
            if count > 0:
                ...
                if isinstance(ex, DDosProtection):
                    if kucoin and "429000" in str(ex):
                        ...
                        # see https://github.com/HuangTrader/HuangTrader/issues/5700 for details.
