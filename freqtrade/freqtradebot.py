"""
HuangTrader is the main module of this bot. It contains the class HuangTrader()
"""
...
from HuangTrader.configuration import validate_config_consistency
from HuangTrader.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from HuangTrader.data.converter import order_book_to_dataframe
from HuangTrader.data.dataprovider import DataProvider
from HuangTrader.edge import Edge
...
from HuangTrader.misc import safe_value_fallback, safe_value_fallback2
from HuangTrader.mixins import LoggingMixin
from HuangTrader.persistence import Order, PairLocks, Trade, init_db
...
from HuangTrader.plugins.protectionmanager import ProtectionManager
from HuangTrader.resolvers import ExchangeResolver, StrategyResolver
from HuangTrader.rpc import RPCManager
from HuangTrader.rpc.external_message_consumer import ExternalMessageConsumer
from HuangTrader.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from HuangTrader.strategy.strategy_wrapper import strategy_safe_wrapper
from HuangTrader.util import MeasureTime
from HuangTrader.util.migrations.binance_mig import migrate_binance_futures_names
from HuangTrader.wallets import Wallets


logger = logging.getLogger(__name__)


class HuangTraderBot(LoggingMixin):
    """
    HuangTrader is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before HuangTraderbot has a chance to start its throttling,
        # so anything in the HuangTraderbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, HuangTrader may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade) -> bool:
        ...
        try:
            ...
            # catching https://github.com/HuangTrader/HuangTrader/issues/9025
