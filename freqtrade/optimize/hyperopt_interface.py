...
from HuangTrader.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for HuangTrader hyperopt
    ...
    def roi_space(self) -> List[Dimension]:
        ...
        It's used by HuangTrader by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy HuangTrader roi_space()
