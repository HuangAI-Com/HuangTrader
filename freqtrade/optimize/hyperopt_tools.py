...
from HuangTrader.constants import FTHYPT_FILEVERSION, Config
from HuangTrader.enums import HyperoptState
from HuangTrader.exceptions import OperationalException
from HuangTrader.misc import deep_merge_dicts, round_dict, safe_value_fallback2
from HuangTrader.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
from HuangTrader.optimize.optimize_reports import generate_wins_draws_losses
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get("is_best") is None:
                raise OperationalException(
                    ...
                    "of HuangTrader and cannot be loaded."
                )
