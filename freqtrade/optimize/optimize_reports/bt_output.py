...
from HuangTrader.constants import UNLIMITED_STAKE_AMOUNT, Config
from HuangTrader.optimize.optimize_reports.optimize_reports import generate_periodic_breakdown_stats
from HuangTrader.types import BacktestResultType
from HuangTrader.util import decimals_per_coin, fmt_coin
...
def text_table_add_metrics(strat_results: Dict) -> str:
    if len(strat_results["trades"]) > 0:
        ...
        # command stores these results and newer version of HuangTrader must be able to handle old
