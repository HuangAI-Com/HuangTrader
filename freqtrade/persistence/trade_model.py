...
from HuangTrader.enums import ExitType, TradingMode
...
from HuangTrader.leverage import interest
from HuangTrader.misc import safe_value_fallback
from HuangTrader.persistence.base import ModelBase, SessionType
from HuangTrader.persistence.custom_data import CustomDataWrapper, _CustomData
from HuangTrader.util import FtPrecise, dt_from_ts, dt_now, dt_ts, dt_ts_none
...
class LocalTrade:
    ...
    def calc_close_trade_value(self, rate: float, amount: Optional[float] = None) -> float:
        ...
        if trading_mode == TradingMode.SPOT:
            ...
            raise OperationalException(
                f"{self.trading_mode.value} trading is not yet available using HuangTrader"
            )
