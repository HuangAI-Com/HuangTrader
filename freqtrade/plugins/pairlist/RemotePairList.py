...
from HuangTrader.configuration.load_config import CONFIG_PARSE_MODE
from HuangTrader.exceptions import OperationalException
from HuangTrader.exchange.types import Tickers
from HuangTrader.plugins.pairlist.IPairList import IPairList, PairlistParameter
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> Tuple[List[str], float]:
        headers = {"User-Agent": "HuangTrader/" + __version__ + " Remotepairlist"}
