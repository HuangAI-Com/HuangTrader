...
import HuangTrader.exchange as exchanges
from HuangTrader.constants import Config, ExchangeConfig
from HuangTrader.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
from HuangTrader.resolvers import IResolver
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in HuangTrader.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("HuangTrader.", ""),
                    }
                )
        return result
