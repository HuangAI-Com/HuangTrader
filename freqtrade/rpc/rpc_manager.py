...
from HuangTrader.enums import NO_ECHO_MESSAGES, RPCMessageType
from HuangTrader.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, HuangTrader) -> None:
        ...
        self._rpc = RPC(HuangTrader)
        config = HuangTrader.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from HuangTrader.rpc.telegram import Telegram
