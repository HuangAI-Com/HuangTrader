...
from HuangTrader.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
...
from HuangTrader.exceptions import OperationalException, StrategyError
from HuangTrader.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from HuangTrader.misc import remove_entry_exit_signals
from HuangTrader.persistence import Order, PairLocks, Trade
from HuangTrader.strategy.hyper import HyperStrategyMixin
from HuangTrader.strategy.informative_decorator import (
    InformativeData,
    PopulateIndicators,
...
from HuangTrader.util import dt_now
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for HuangTrader strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from HuangTrader.freqai.utils import download_all_data_for_training
            from HuangTrader.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def adjust_entry_price(
        ...
        **kwargs,
        ...
        For full documentation please go to https://www.HuangTrader.io/en/latest/strategy-callbacks/
    ...
    def feature_engineering_expand_all(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://www.HuangTrader.io/en/latest/freqai-parameter-table/#feature-parameters

        https://www.HuangTrader.io/en/latest/freqai-feature-engineering/#defining-the-features
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by HuangTrader itself, but intended to be used if users lock pairs
