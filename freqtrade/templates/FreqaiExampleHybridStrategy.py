...
from HuangTrader.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    FreqAI to bolster a typical HuangTrader strategy.

    Launching this strategy would be:

    HuangTrader trade --strategy FreqaiExampleHybridStrategy --strategy-path HuangTrader/templates
