...
from HuangTrader_client.ft_client import add_arguments, main_exec
...
def get_rest_client():
    client = FtRestClient("http://localhost:8080", "HuangTraderr", "password")
...
def test_FtRestClient_init():
    ...
    assert client._session.auth == ("HuangTraderr", "password")
...
def test_ft_client(mocker, capsys, caplog):
    ...
    mock = mocker.patch("HuangTrader_client.ft_client.FtRestClient._call")
