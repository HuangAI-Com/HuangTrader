...
from HuangTrader.enums import CandleType, MarginMode, TradingMode
from HuangTrader.exceptions import RetryableOrderError, TemporaryError
from HuangTrader.exchange.exchange import timeframe_to_minutes
...
def test_load_leverage_tiers_okx(default_conf, mocker, markets, tmp_path, caplog, time_machine):
    ...
    # fd_mock = mocker.patch('HuangTrader.exchange.exchange.file_dump_json')
    api_mock = MagicMock()
