...
def get_futures_exchange(exchange_name, exchange_conf, class_mocker):
    if EXCHANGES[exchange_name].get("futures") is not True:
        ...
        class_mocker.patch("HuangTrader.exchange.binance.Binance.fill_leverage_tiers")
        class_mocker.patch(f"{EXMS}.fetch_trading_fees")
        class_mocker.patch("HuangTrader.exchange.okx.Okx.additional_exchange_init")
        class_mocker.patch("HuangTrader.exchange.binance.Binance.additional_exchange_init")
        class_mocker.patch("HuangTrader.exchange.bybit.Bybit.additional_exchange_init")
