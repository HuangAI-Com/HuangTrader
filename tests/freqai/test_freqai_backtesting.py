...
from HuangTrader.commands.optimize_commands import setup_optimize_configuration
...
from HuangTrader.enums.candletype import CandleType
...
def test_freqai_backtest_start_backtest_list(freqai_conf, mocker, testdatadir, caplog):
    ...
    mocker.patch("HuangTrader.optimize.backtesting.history.load_data")
    mocker.patch("HuangTrader.optimize.backtesting.history.get_timerange", return_value=(now, now))
...
def test_freqai_backtest_consistent_timerange(mocker, freqai_conf):
    ...
    gbs = mocker.patch("HuangTrader.optimize.backtesting.generate_backtest_stats")
