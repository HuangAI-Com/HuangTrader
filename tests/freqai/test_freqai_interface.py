...
from HuangTrader.freqai.utils import download_all_data_for_training, get_required_data_timerange
...
def test_plot_feature_importance(mocker, freqai_conf):
    from HuangTrader.freqai.utils import plot_feature_importance
