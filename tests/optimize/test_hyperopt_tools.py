...
from HuangTrader.constants import FTHYPT_FILEVERSION
from HuangTrader.exceptions import OperationalException
from HuangTrader.optimize.hyperopt_tools import HyperoptTools, hyperopt_serializer
...
def test_try_export_params(default_conf, tmp_path, caplog, mocker):
    ...
    default_conf["user_data_dir"] = tmp_path
    export_mock = mocker.patch("HuangTrader.optimize.hyperopt_tools.HyperoptTools.export_params")
