...
from HuangTrader.optimize.hyperopt_loss.hyperopt_loss_short_trade_dur import ShortTradeDurHyperOptLoss
...
def test_hyperoptlossresolver(mocker, default_conf) -> None:
    ...
    mocker.patch(
        "HuangTrader.resolvers.hyperopt_resolver.HyperOptLossResolver.load_object",
