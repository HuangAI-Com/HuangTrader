...
from HuangTrader.commands.optimize_commands import start_lookahead_analysis
from HuangTrader.data.history import get_timerange
from HuangTrader.exceptions import OperationalException
from HuangTrader.optimize.analysis.lookahead import Analysis, LookaheadAnalysis
...
def test_start_lookahead_analysis(mocker):
    ...
    mocker.patch.multiple(
        "HuangTrader.optimize.analysis.lookahead_helpers.LookaheadAnalysisSubFunctions",
...
def test_initialize_single_lookahead_analysis(lookahead_conf, mocker, caplog):
    ...
    start_mock = mocker.patch("HuangTrader.optimize.analysis.lookahead.LookaheadAnalysis.start")
    strategy_obj = {
        "name": "strategy_test_v3_with_lookahead_bias",
        "location": Path(lookahead_conf["strategy_path"], f"{lookahead_conf['strategy']}.py"),
    }
