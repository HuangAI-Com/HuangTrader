...
from HuangTrader.constants import BACKTEST_BREAKDOWNS, DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN
...
from HuangTrader.optimize.optimize_reports.bt_output import text_table_tags
from HuangTrader.optimize.optimize_reports.optimize_reports import (
    _get_resample_from_period,
    calc_streak,
    generate_tag_metrics,
)
from HuangTrader.resolvers.strategy_resolver import StrategyResolver
from HuangTrader.util import dt_ts
from HuangTrader.util.datetime_helpers import dt_from_ts, dt_utc
...
def test_store_backtest_stats(testdatadir, mocker):
    dump_mock = mocker.patch("HuangTrader.optimize.optimize_reports.bt_storage.file_dump_json")
...
def test_store_backtest_candles(testdatadir, mocker):
    dump_mock = mocker.patch("HuangTrader.optimize.optimize_reports.bt_storage.file_dump_joblib")
