...
from HuangTrader.constants import DEFAULT_DB_PROD_URL
from HuangTrader.enums import TradingMode
from HuangTrader.exceptions import OperationalException
from HuangTrader.persistence import Trade, init_db
from HuangTrader.persistence.base import ModelBase
from HuangTrader.persistence.migrations import get_last_sequence_ids, set_sequence_ids
...
def test_init_custom_db_url(default_conf, tmp_path):
    ...
    filename = tmp_path / "HuangTrader2_test.sqlite"
...
def test_init_prod_db(default_conf, mocker):
    ...
    create_engine_mock = mocker.patch("HuangTrader.persistence.models.create_engine", MagicMock())
...
def test_init_dryrun_db(default_conf, tmpdir):
    filename = f"{tmpdir}/HuangTrader2_prod.sqlite"
...
def test_migrate(mocker, default_conf, fee, caplog):
    ...
    mocker.patch("HuangTrader.persistence.models.create_engine", lambda *args, **kwargs: engine)
