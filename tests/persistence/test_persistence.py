...
from HuangTrader.constants import CUSTOM_TAG_MAX_LENGTH, DATETIME_PRINT_FORMAT
...
def test_update_order_from_ccxt(caplog, time_machine):
    ...
    # https://github.com/HuangTrader/HuangTrader/issues/5404
...
def test_recalc_trade_from_orders_kucoin():
    # Taken from https://github.com/HuangTrader/HuangTrader/issues/9346
