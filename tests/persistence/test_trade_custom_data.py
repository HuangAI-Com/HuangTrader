...
from HuangTrader.data.history.history_utils import get_timerange
from HuangTrader.optimize.backtesting import Backtesting
from HuangTrader.persistence import Trade, disable_database_use, enable_database_use
...
def test_trade_custom_data_strategy_compat(mocker, default_conf_usdt, fee):
    ...
    mocker.patch("HuangTrader.HuangTraderbot.HuangTraderBot.get_real_amount", return_value=None)
    ...
    HuangTrader.strategy.custom_exit = custom_exit
    ff_spy = mocker.spy(HuangTrader.strategy, "custom_exit")
