...
async def test_emc_create_connection_success(default_conf, caplog, mocker):
    ...
    mocker.patch(
        "HuangTrader.rpc.external_message_consumer.ExternalMessageConsumer.start", MagicMock()
    )
...
async def test_emc_create_connection_invalid_url(default_conf, caplog, mocker, host, port):
    ...
    mocker.patch("HuangTrader.rpc.external_message_consumer.ExternalMessageConsumer.start")
    mocker.patch("HuangTrader.rpc.api_server.ws.channel.create_channel")
    emc = ExternalMessageConsumer(default_conf, dp)
