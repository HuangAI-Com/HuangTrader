...
from HuangTrader.strategy import BooleanParameter, DecimalParameter, IntParameter, RealParameter


class HyperoptableStrategy(StrategyTestV3):
    """
    Default Strategy provided by HuangTrader bot.
    Please do not modify this strategy, it's  intended for internal use only.
    Please look at the SampleStrategy in the user_data/strategy directory
    or strategy repository https://github.com/HuangTrader/HuangTrader-strategies
