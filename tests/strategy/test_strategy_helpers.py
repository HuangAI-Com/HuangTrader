...
from HuangTrader.strategy import merge_informative_pair, stoploss_from_absolute, stoploss_from_open
...
def test_informative_decorator(mocker, default_conf_usdt, trading_mode):
    ...
    mocker.patch(
        "HuangTrader.data.dataprovider.DataProvider.historic_ohlcv", side_effect=test_historic_ohlcv
    )
