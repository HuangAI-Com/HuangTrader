...
from HuangTrader.loggers import (
    FTBufferingHandler,
...
from HuangTrader.loggers.set_log_levels import (
...
def test_reduce_verbosity():
    setup_logging_pre()
    reduce_verbosity_for_bias_tester()
    prior_level = logging.getLogger("HuangTrader").getEffectiveLevel()

    assert logging.getLogger("HuangTrader.resolvers").getEffectiveLevel() == logging.WARNING
    assert logging.getLogger("HuangTrader.strategy.hyper").getEffectiveLevel() == logging.WARNING
    # base level wasn't changed
    assert logging.getLogger("HuangTrader").getEffectiveLevel() == prior_level

    restore_verbosity_for_bias_tester()

    assert logging.getLogger("HuangTrader.resolvers").getEffectiveLevel() == prior_level
    assert logging.getLogger("HuangTrader.strategy.hyper").getEffectiveLevel() == prior_level
    assert logging.getLogger("HuangTrader").getEffectiveLevel() == prior_level
    # base level wasn't changed
