...
from HuangTrader.util.migrations import migrate_binance_futures_data, migrate_data
...
def test_migration_wrapper(default_conf_usdt, mocker):
    default_conf_usdt["trading_mode"] = "futures"
    binmock = mocker.patch("HuangTrader.util.migrations.migrate_binance_futures_data")
    funding_mock = mocker.patch("HuangTrader.util.migrations.migrate_funding_fee_timeframe")
